...
urlpatterns = [
    ...
    path('post/<int:id>/', TemplateView.as_view(template_name='blog/post_detail.html'), name='post-detail'),
    path("post/new/", TemplateView.as_view(template_name="blog/post_form.html"), name="post-create"),
